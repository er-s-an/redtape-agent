...
_RULES: dict[tuple[str, str], Rule] = {
    ...
    ("us-uscis", "lawful_status"): Rule(
        jurisdiction="us-uscis",
        doc_type="lawful_status",
        version=1,
        effective_from="2026-01-01",
        source_url="https://www.uscis.gov/visit-the-united-states/extend-your-stay",
        payload={
            "service": "status_extension",
            "requires_appointment": False,
            "processing_weeks_min": 12,
            "processing_weeks_max": 24,
            "fee_usd": 470,
            "required_items": ["current status document", "passport", "application form", "fee"],
        },
    ),
    ("us-travel", "passport_validity"): Rule(        jurisdiction="us-travel",
